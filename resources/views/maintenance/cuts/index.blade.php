...
<style>
    ...
    @media(min-width:768px){.cut-table-wrap{overflow-x:visible}.cut-table{width:100%;min-width:0;table-layout:fixed}.cut-ticket-link{min-width:0}.cut-table th,.cut-table td{padding-left:.55rem;padding-right:.55rem}.cut-table th:nth-child(2){width:16%}.cut-table th:nth-child(3){width:17%}.cut-table th:nth-child(4),.cut-table th:nth-child(5){width:13%}.cut-table th:nth-child(6),.cut-table th:nth-child(7){width:10%}.cut-table th:nth-child(8){width:11%}.cut-table th:last-child,.cut-table td:last-child{padding-right:1.75rem}}
    @media(max-width:767px){.cut-table{min-width:900px}.cut-table-wrap{overflow-x:auto}}
</style>
@endpush
